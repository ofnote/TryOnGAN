...
def training_loop(
    ...
    P = PoseEncoder(imageSize=training_set.resolution, channel_base = G_kwargs.channel_base)
    ...
    ddp_modules = dict()
    for name, module in [('G_mapping', G.mapping), ('G_synthesis', G.synthesis), ('D', D), ('P', P), (None, G_ema), ('augment_pipe', augment_pipe)]:
